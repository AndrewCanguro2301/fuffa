...
// Describe how the game is played
    ...
    printf("\nThe computer will remove them, and then prompt you "); printf("to enter the same sequence.");
...
// Now overwrite the digit sequence
                            printf("\r");                                       // Go to beginning of the line
                                ...
                                srand(seed);                                            // Reinitialize the random sequence
                                    ...
                                    for(unsigned int i = 1 ; i <= digits ; ++i)         // Read the input sequence & check against the original
                                    {
